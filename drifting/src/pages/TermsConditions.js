      ...
      <div className="container">
        ...
        <div className="body">
          ...
          <div id="terms">
            ...
            <br />
            Our purpose is to create a safe place for students to express their stress. Please be empathetic to each other, putting yourself in others' shoes. Do not produce any harmful language, we reserve the right to change, modify, add or remove.
            <br />
            ...
            <ol>
              ...
              <li>
                To send, knowingly receive, upload, download, use or re-use any material which does not comply with our content standards as set out in these terms and conditions.
            </li>
              <li>
            ...
            <p>
              Our Products
                <ul>
                <li>
                  Our products are for educational purposes only. The information contained within our website is not exhaustive and cannot always reflect all the most recent research in all areas of medicine.
                  </li>
                <li>
                  You should work within the bounds of your own competencies, using your own skill and knowledge and therefore the documents should be used to support good practice, not to replace it.
                  </li>
              </ul>
            </p>
            ...
            <p>
              Data Retention
                <ul>
                <li>
                  We will only retain the data for any user input in the Drifting website.
                  <br />
